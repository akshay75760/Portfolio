const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'Email',
      href: 'mailto:kakshay70007@gmail.com',
      icon: (
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-2xl font-bold">Akshay Kumar</h3>
            </div>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className="w-10 h-10 bg-gray-800 dark:bg-gray-700 rounded-lg flex items-center justify-center hover:bg-gray-600 dark:hover:bg-gray-600 transition-all duration-300 transform hover:scale-125 hover:rotate-12 hover:-translate-y-1 hover:shadow-xl group"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">kakshay70007@gmail.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
